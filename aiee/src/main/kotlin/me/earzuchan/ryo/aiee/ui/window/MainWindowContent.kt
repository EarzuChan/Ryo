...
import me.earzuchan.ryo.aiee.ui.view.DialogHostView
import me.earzuchan.ryo.aiee.ui.view.MenuHostView
...
fun FrameWindowScope.MainWindowContent(appDuty: AppDuty, ryoWindowScope: RyoWindowScope) {
    ...
    CompositionLocalProvider(LocalWindowDutyScope provides appDuty) {
        Box(Modifier.fillMaxSize().onPreviewKeyEvent(commandService::handleKeyEvent)) {
            ...
            MenuHostView(appDuty.menuService)
            DialogHostView(appDuty.dialogService)
        }
    }
}
